...
const dataFaq = [
  {
    ...
    answer:
      "MonTaskPro is a task management application that helps you organize and prepare for your projects. The more you plan, the more you will accomplish, and the more you will enjoy the result.",
  },
  {
    question: "How to use MonTaskPro?",
    answer:
      "You can use MonTaskPro by registering first, then you can create a task, set a due date, and track progress from anywhere.",
  },
  {
    question: "What is the benefit of using MonTaskPro?",
    answer:
      "MonTaskPro can help you manage your time effectively, you can create a task, set a due date, and track progress from anywhere.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You can get a premium account by paying a monthly subscription fee of Rp. 50.000,-",
  },
];
    ...
    <nav className="navbar">
      ...
      <div className="navbar-btn">
        <Button
          ...
          onClickBtn={loginClick}
        />
        <Button
          title="Sign Up"
          className="btn signup-button"
          onClickBtn={signUpClick}
        />
      </div>
    </nav>
  );
    ...
    <section className="container-hero wrapper">
      <div className="container-hero__article">
        <div>
          ...
          <p className="p-teks__poppins">
            Task Management App - Create tasks, set due dates, and track
  ...
  return (
    <section className="container-service wrapper">
      <div className="container-service__title">
        ...
        <p className="p-teks__poppins">
          Task Management App - Create tasks, set due dates, and track progress
          from anywhere.
        </p>
      </div>
    ...
    <section className="container-testimoni wrapper">
      ...
      <div className="container-testimoni__content">
        <div className="container-testimoni__content__imageWrapper">
          <img
            src={TestimoniGirl}
            className="testimoni-girl image"
            alt="testimoni-girl"
          ></img>
        </div>
        <div className="container-testimoni__content__textWrapper">
          <h1>Our Story</h1>
          <p>
            This application is very amazing, I can manage time effectively, i
            am very easy to use this application, highly recommended for
            students who have difficulty managing time.
          </p>
          <p>
            <strong>Adiva Arini Putri</strong>
          </p>
          <Button
            title="Lets Start"
            className="btn signup-button"
